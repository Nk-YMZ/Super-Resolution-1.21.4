...
uniform mat4 u_lastProjectionMatrix;
uniform mat4 u_lastModelViewMatrix;
/////
#import <sodium:include/chunk_material.glsl>

out vec4 v_Color;
out vec2 v_TexCoord;
out vec4 v_lastPosition;
...
void main() {
    ...
    v_currentPosition = vec4(gl_Position);
    v_lastPosition = u_lastProjectionMatrix * u_lastModelViewMatrix * vec4(position, 1.0);
