package io.homo.superresolution.fsr2.v221.struct;
...
import io.homo.superresolution.fsr2.v221.Fsr2DispatchDescription;
...
import static io.homo.superresolution.fsr2.v221.Fsr2Utils.ffxFsr2GetJitterPhaseCount;
...
public class Fsr2CBFSR2 implements IBufferData {
    ...
    public void update(Fsr2Context context, Fsr2DispatchDescription desc, Fsr2Dimensions dims) {
        ...
        computeDeviceToViewDepth(
                desc.cameraNear,
                desc.cameraFar,
                context.config.flags.isEnableDepthInverted(),
                context.config.flags.isEnableDepthInfinite(),
