...
import io.homo.superresolution.core.gui.google.material.dislike.DislikeAnalyzer;
...
import io.homo.superresolution.core.gui.google.material.temperature.TemperatureCache;
...
class ColorSpec2021 implements ColorSpec {
    ...
    public TonalPalette getPrimaryPalette(
        ...
        return switch (variant) {
            ...
            case FRUIT_SALAD -> TonalPalette.fromHueAndChroma(
    ...
    public TonalPalette getSecondaryPalette(
            ...
            double contrastLevel) {
        return switch (variant) {
            case CONTENT, FIDELITY -> TonalPalette.fromHueAndChroma(
    ...
    public TonalPalette getTertiaryPalette(
        ...
        return switch (variant) {
            ...
            case RAINBOW, TONAL_SPOT -> TonalPalette.fromHueAndChroma(
    ...
    public TonalPalette getNeutralVariantPalette(
            ...
            double contrastLevel) {
        return switch (variant) {
            case CONTENT -> TonalPalette.fromHueAndChroma(
                    sourceColorHct.getHue(), (sourceColorHct.getChroma() / 8.0) + 4.0);
            case FIDELITY -> TonalPalette.fromHueAndChroma(
                    sourceColorHct.getHue(), (sourceColorHct.getChroma() / 8.0) + 4.0);
