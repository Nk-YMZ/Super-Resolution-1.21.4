...
public abstract class NVGDrawCommand extends DrawCommand {
    protected NanoVGContext context;

    public NVGDrawCommand(NanoVGContext context, DrawCommandType type) {
        super(type);
