...
package io.homo.superresolution.core.graphics.nanovg;
...
public class NanoVGFontLoader {
    ...
    public static void initAndLoad() {
        FONT_MAP.put(REGULAR_VARIATION, new NanoVGFont("HarmonyOSFont Regular", "/assets/super_resolution/font/HarmonyOS_Sans_SC_Regular.ttf"));
