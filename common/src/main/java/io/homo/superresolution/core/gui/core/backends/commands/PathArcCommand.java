...
public abstract class PathArcCommand extends DrawCommand {
    ...
    public PathArcCommand(float x, float y, float radius, float a0, float a1) {
        super(DrawCommandType.PathArc);
        this.x = x;
        this.y = y;
        this.radius = radius;
        this.a0 = a0;
