...
public class VulkanValidationLayers implements Destroyable {
    ...
    public void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT createInfo) {
    ...
    public PointerBuffer getValidationLayersPointerBuffer(MemoryStack stack) {
