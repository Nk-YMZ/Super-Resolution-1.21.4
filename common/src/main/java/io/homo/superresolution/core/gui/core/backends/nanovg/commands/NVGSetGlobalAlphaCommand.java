...
public class NVGSetGlobalAlphaCommand extends NVGDrawCommand {
    protected final float alpha;

    public NVGSetGlobalAlphaCommand(NanoVGContext context, float alpha) {
        super(context, DrawCommandType.SetGlobalAlpha);
        this.alpha = alpha;
    }
