...
public class NVGSetStrokeColorCommand extends NVGDrawCommand {
    protected final Color color;

    public NVGSetStrokeColorCommand(NanoVGContext context, Color color) {
        super(context, DrawCommandType.SetStrokeColor);
        this.color = color;
    }
