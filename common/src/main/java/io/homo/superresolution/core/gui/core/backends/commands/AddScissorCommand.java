...
public abstract class AddScissorCommand extends DrawCommand {
    protected final float x;
    protected final float y;
    protected final float width;
    protected final float height;

    public AddScissorCommand(float x, float y, float width, float height) {
        super(DrawCommandType.AddScissor);
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
