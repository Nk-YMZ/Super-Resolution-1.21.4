...
public class NVGRestoreStateCommand extends NVGDrawCommand {
    public NVGRestoreStateCommand(NanoVGContext context) {
        super(context, DrawCommandType.RestoreState);
    }
