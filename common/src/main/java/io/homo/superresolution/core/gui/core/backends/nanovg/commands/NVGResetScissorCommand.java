...
public class NVGResetScissorCommand extends NVGDrawCommand {
    public NVGResetScissorCommand(NanoVGContext context) {
        super(context, DrawCommandType.ResetScissor);
    }
