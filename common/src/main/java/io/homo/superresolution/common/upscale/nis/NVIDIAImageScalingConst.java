...
public class NVIDIAImageScalingConst {
    ...
    public static final int kPhaseCount = 64;
    public static final int kFilterSize = 8;
    public static final float[] coef_scale = new float[]{
    ...
    public static final float[] coef_usm = new float[]{
    ...
    public static final char[][] coef_scale_fp16 = {
            {0, 0, 15360, 0, 0, 0, 0, 0},
    ...
    public static final char[][] coef_usm_fp16 = {
