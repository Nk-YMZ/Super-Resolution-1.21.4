...
public abstract class AbstractShaderProgramBuilder {
        ...
        private final Map<String, GeneralShaderProgram.ShaderInclude> shaderIncludeList = new HashMap<>();
        ...
        public AbstractShaderProgramBuilder addShaderInclude(GeneralShaderProgram.ShaderInclude include) {
        ...
        public abstract AbstractShaderProgram build();

        protected AbstractShaderProgram setShaderText(AbstractShaderProgram shader){
