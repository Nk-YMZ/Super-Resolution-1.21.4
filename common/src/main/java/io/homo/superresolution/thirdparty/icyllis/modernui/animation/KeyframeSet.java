...
import io.homo.superresolution.thirdparty.icyllis.modernui.animation.Keyframe.FloatKeyframe;
import io.homo.superresolution.thirdparty.icyllis.modernui.animation.Keyframe.IntKeyframe;
import io.homo.superresolution.thirdparty.icyllis.modernui.animation.Keyframe.ObjectKeyframe;
...
public class KeyframeSet implements Keyframes {
    ...
    public static FloatKeyframeSet ofFloat(@Nonnull float... values) {
        ...
        if (badValue) {
            SuperResolution.LOGGER.warn(Animator.MARKER, "Bad value (NaN) in float animator");
        }
