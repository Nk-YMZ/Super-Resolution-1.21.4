...
public class Fsr2v233AccumulatePipeline extends Fsr2Pipeline {
    private GlShaderProgram program;

    public Fsr2v233AccumulatePipeline(Fsr2Context resources) {
        super(resources);
    }
    ...
    public void init() {
        ...
        pipeline.add("fsr2_accumulate", jobBuilder.build());
    }
