...
import io.homo.superresolution.thirdparty.icyllis.modernui.util.ArrayMap;
 ...
 * <a href="https://developer.android.com/guide/topics/graphics/prop-animation.html#choreography">Property
...
public final class AnimatorSet extends Animator implements AnimationHandler.FrameCallback {
    ...
    public void setStartDelay(long startDelay) {
        ...
        if (startDelay < 0) {
            SuperResolution.LOGGER.warn(MARKER, "Start delay should always be non-negative");
            startDelay = 0;
        }
     ...
     * {@link AnimatorListener#onAnimationRepeat(Animator)},
    ...
    void animateBasedOnPlayTime(long currentPlayTime, long lastPlayTime, boolean inReverse) {
        ...
        for (Node node : unfinishedNodes) {
            long playTime = getPlayTimeForNode(currentPlayTime, node, false);
    ...
    private void printChildCount() {
        ...
        list.add(mRootNode);
        SuperResolution.LOGGER.debug(MARKER, "Current tree: ");
        int index = 0;
        while (index < list.size()) {
            ...
            SuperResolution.LOGGER.debug(MARKER, builder.toString());
        }
    }
    ...
    private void updatePlayTime(@Nonnull Node parent, @Nonnull ArrayList<Node> visited) {
        ...
        for (int i = 0; i < childrenSize; i++) {
            ...
            if (index >= 0) {
                ...
                SuperResolution.LOGGER.warn(MARKER, "Cycle found in AnimatorSet: " + this);
                continue;
            }
