package io.homo.superresolution.upscale.fsr2.utils;
...
public class FFXError {
    ...
    public static final int FFX_ERROR_GL_KHR_shader_subgroup = 0x7000000e;
    ...
    public static String returnErrorText(int errorCode) {
            ...
            switch (errorCode){
                ...
                case FFX_ERROR_GL_KHR_shader_subgroup->{
                    return "FFX_ERROR_GL_KHR_shader_subgroup";
                }
            }
            return "WTF";
    }
