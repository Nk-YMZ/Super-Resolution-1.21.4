...
std::vector<NVGglyphPosition> NanoVGContext::TextGlyphPositions(float x, float y, const std::string &string,
...
std::vector<NVGtextRow> NanoVGContext::TextBreakLines(const std::string &string, const std::string *end,
                                                      float breakRowWidth) {
