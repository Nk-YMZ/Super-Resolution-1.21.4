...
| `upscale_config.sr_internal_texture_format` | 指定超分内部的纹理格式，会影响算法中间纹理的格式与临时输入输出纹理的格式，默认`r11b11g10f`，接受`rgb8`,`rgba8`,`rgba16f`,`rgba16`,`rgb16f`,`r11b11g10f`,`r11b11g10f` | `r11b11g10f` |
